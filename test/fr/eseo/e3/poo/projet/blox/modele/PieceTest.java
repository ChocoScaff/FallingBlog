...
public class PieceTest {
    ...
    void placerPieceTest() {
        ...
        Assertions.assertEquals(new Coordonnees(2, 2), piece.getElements().get(0).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(2, 1), piece.getElements().get(1).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(2, 0), piece.getElements().get(2).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(3, 2), piece.getElements().get(3).getCoordonnees());
    }
    ...
    void tournerHorrairTest() {
        ...
        Assertions.assertEquals(new Coordonnees(2, 2), piece.getElements().get(0).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(3, 2), piece.getElements().get(1).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(4, 2), piece.getElements().get(2).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(2, 3), piece.getElements().get(3).getCoordonnees());
    }
    ...
    void tournerAntiHorrairTest() {
        ...
        Assertions.assertEquals(new Coordonnees(2, 2), piece.getElements().get(0).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(1, 2), piece.getElements().get(1).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(0, 2), piece.getElements().get(2).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(2, 1), piece.getElements().get(3).getCoordonnees());
    }
    ...
    void deplaceHorizontalTest() {
        ...
        Assertions.assertEquals(new Coordonnees(3, 2), piece.getElements().get(0).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(3, 1), piece.getElements().get(1).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(3, 0), piece.getElements().get(2).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(4, 2), piece.getElements().get(3).getCoordonnees());
    }
    ...
    void deplaceVerticalTest() {
        ...
        Assertions.assertEquals(new Coordonnees(2, 3), piece.getElements().get(0).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(2, 2), piece.getElements().get(1).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(2, 1), piece.getElements().get(2).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(3, 3), piece.getElements().get(3).getCoordonnees());
    }
    ...
    void tournerOPieceTest() {
        ...
        Assertions.assertEquals(new Coordonnees(3, 2), piece.getElements().get(1).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(2, 1), piece.getElements().get(2).getCoordonnees());
        Assertions.assertEquals(new Coordonnees(3, 1), piece.getElements().get(3).getCoordonnees());
    }
}
